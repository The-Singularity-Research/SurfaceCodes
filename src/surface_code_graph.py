...
class SurfaceCodeGraph(MultiGraph):
    def __init__(self, sigma: Tuple[Tuple[int]], alpha: Tuple[Tuple[int]]):
        ...
        # glue the nodes corresponding to the pairs
        ...
        # Build vector space basis for the vertices, edges, and face
        self.vertex_basis()
        self.edge_basis()
        self.face_basis()
        # Build the (matrix) differentials of the chain complex F --> E --> V
        # d_2: F --> E, d_1: E --> V
        self.d_2()
        self.d_1()
